<?php
/*
Plugin Name: Git in my wordpress

Description: List your github  projects on your Wordpress 
Version: 1.0
Author: 
*/
...
class WPGH_Core
{
     ...
     *  replace it with the project list. Ex, {{github:sagagautam5}}
    ...
    static function replaceCallback($matches)
    {
        ...
        foreach($projects as $project)
        {
            ...
            $template = str_replace('{{PROJECT_DOWNLOAD_LINK}}', $project->download_link, $template);
...
TEMP;
    ...
    {
        add_options_page('Github', 'GitHub', 'edit_pages', 'wordpress-github.php', array(__CLASS__, 'adminMenuCallback'));
    }
     ...
     */
     ...
     function form($instance) 
     {
       ...
       <p>
            ...
            <small>eg, github:username
		ex:github.com:sagautam5	
</small>
       </p>
